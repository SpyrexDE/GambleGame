    ...
    <body>
        ...
        <div class="header">
                  ...
                  <a href="LIProfile.php">
                    <img class= "logo selected" src="<?php echo $_SESSION['image'].'?='.filemtime($_SESSION['image']);?>" height="100" width="100" >
                  </a>
      ...
      <div class="content">
        ...
        <div class="panel" style="height: 200px;">
                ...
                <img class= "profileLogo" src="<?php echo $_SESSION['image'].'?='.filemtime($_SESSION['image']);?>" height="140" width="140" >
